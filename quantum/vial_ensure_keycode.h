...
/* LCG/RCG are provided by quantum_keycodes.h in this QMK version. */

/* Compatibility aliases for keycode names removed from modern QMK.
 * The underlying values are unchanged, so the protocol asserts below
 * remain meaningful. */
#ifndef RGB_TOG
